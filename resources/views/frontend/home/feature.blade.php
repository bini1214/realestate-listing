 ...
 <section class="feature-section sec-pad bg-color-1">
            <div class="auto-container">
                <div class="sec-title centred">
                    ...
                    <p>Explore a range of premium properties designed to meet your every need. 
                        Whether you're looking to rent or buy.</p>
                </div>
    ...
    <figure class="author-thumb">
        <img src="{{ $item->user->photo ? url('upload/agent_images/' . $item->user->photo) : url('upload/aryian.jpg') }}" alt="">
        <h6>{{ $item->user->name }}</h6>
    </figure>
@else
    <figure class="author-thumb">
        <img src="{{ url('upload/aryian.jpg') }}" alt="">
        <h6>Admin</h6>
    </figure>
@endif
